...
public class ClassRankAdapter extends CommonAdapter<RankBean> {

    public ClassRankAdapter(Context context, List<RankBean> mDatas) {
        super(context, mDatas);
    }

    @Override
    protected int getLayoutId() {
        return GlobalData.isPad() ? R.layout.item_class_rank : R.layout.item_class_rank_phone;
    }
