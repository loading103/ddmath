...
public class ClassicReportFragment extends ReportBaseFragment implements PullToRefreshBase.OnRefreshListener2, AdapterView.OnItemClickListener {
    ...
    private void initView(View root) {
        ...
        mLvReport = root.findViewById(R.id.lv_report);
        ...
        new StudyfeedbackModel().queryReports(mStudentId, type, pageNum + "", pageSize + "", new RequestListener<QueryReportsInfo>() {
            ...
            public void onSuccess(QueryReportsInfo vo) {
                ...
                if (vo == null || vo.getItems() == null || vo.getItems().size() == 0) {
                    ...
                    mLoadingPager.setEmptyText("暂时还没有新的提升报告，快去学习吧～");
                    return;
                }
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        String timeText = ReportUtils.getCreateTimeText(reportInfo.getCreateTime());
