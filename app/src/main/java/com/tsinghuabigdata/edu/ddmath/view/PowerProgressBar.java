...
public class PowerProgressBar extends View {
    ...
    private void initView() {
        ...
        mWhiteRectPaint.setStrokeWidth(dp2px(60));
        ...
        mFirstRectPaint.setStrokeWidth(dp2px(30));
        ...
        mSecondRectPaint.setStrokeWidth(dp2px(28));
        ...
        mThirdRectPaint.setStrokeWidth(dp2px(20));
        ...
        mFourthRectPaint.setStrokeWidth(dp2px(10));
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        LogUtils.i( "allWidth=" + allWidth + "mArcRadius=" + mArcRadius);
        mArcCenterX = w / 2f;
        mArcCenterY = allWidth / 2f;
        LogUtils.i( "mArcCenterX=" + mArcCenterX + "mArcCenterY=" + mArcCenterY);
        ...
        LogUtils.i( "top=" + mArcRect.top + "bottom  =" + mArcRect.bottom);
        LogUtils.i( "left=" + mArcRect.left + "right  =" + mArcRect.right);
        //mArcRect.inset(mArcWidth / 2, mArcWidth / 2);

        mWhiteArcRect = new RectF();
        float distance7 = mArcRadius - dp2px(62);
        ...
        float distance1 = mArcRadius - dp2px(62);
        ...
        float distance2 = mArcRadius - dp2px(62);
        ...
        float distance3 = mArcRadius - dp2px(62);
        ...
        float distance4 = mArcRadius - dp2px(32);
        ...
        float distance5 = mArcRadius - dp2px(30);
        ...
        float textDis1 = mArcRadius - dp2px(16);
        ...
        float textDis2 = mArcRadius - dp2px(20);
    ...
    protected void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        //LogUtils.i( "mProgress=" + mProgress);
        //最外层白色边框 测试使用
    ...
    private void drawText(Canvas canvas) {
        ...
        canvas.drawText(title, mArcCenterX - titleWidth / 2, mArcCenterY - dp2px(66), mTextPaint3);
    ...
    public void setPower(int value) {
        //LogUtils.i( "value=" + value + "startValue=" + startValue + "endValue=" + endValue);
        curValue = value;
        invalidate();
    }
}
