 ...
 *  2016/10/18.
 */
class QALayoutManager extends LinearLayoutManager {
    ...
    QALayoutManager(Context context) {
        super(context);
    }

    @SuppressWarnings("UnusedDeclaration")
    public QALayoutManager(Context context, int orientation, boolean reverseLayout) {
...
////        Logger.e("QALayoutManager state:" + state.toString());
