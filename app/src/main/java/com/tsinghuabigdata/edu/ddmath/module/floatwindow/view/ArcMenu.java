...
public class ArcMenu extends ViewGroup implements View.OnClickListener{
    ...
    /**菜单按钮自动放大动画控制*/
    private State mMenuAnimationState= State.CLOSE;
    /**菜单按钮字段放大动画*/
    ...
    public ArcMenu(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        int pos=typedArray.getInt(R.styleable.ArcMenu_am_position, 4);
        switch (pos){
            case LEFT_TOP:
        ...
        mRadius= (int) typedArray.getDimension(R.styleable.ArcMenu_am_radius,defaultRadius);
        typedArray.recycle();
    }
    //测量子View
    @Override
    ...
    public interface  onMenuItemClickListner{
        void onClick(View childView, int position);
    }
    /**主菜单点击事件*/
    @Override
