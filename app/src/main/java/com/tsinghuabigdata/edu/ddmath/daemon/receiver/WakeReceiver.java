package com.tsinghuabigdata.edu.ddmath.daemon.receiver;
...
public class WakeReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (GRAY_WAKE_ACTION.equals(action) || Intent.ACTION_USER_PRESENT.equalsIgnoreCase(action) ) {
            Log.i(TAG, "wake !! action = " + action );
