...
import com.tsinghuabigdata.edu.ddmath.module.neteaseim.base.util.log.LogUtil;
...
public class NetworkUtil {
	...
	private static byte curNetworkType;

	private synchronized static void setNetworkType( byte type ){
		curNetworkType = type;
	}
	/*
	 * 
            ...
            if (ni != null) {
                if (ni.getType() == ConnectivityManager.TYPE_WIFI) {
                    ...
                    if (ni.getType() == ConnectivityManager.TYPE_MOBILE) {
                        ...
                        case TelephonyManager.NETWORK_TYPE_1xRTT:
                        case TelephonyManager.NETWORK_TYPE_IDEN:
                            return LinkNetWorkType.Type_2G;
                        case TelephonyManager.NETWORK_TYPE_UMTS:
                        case TelephonyManager.NETWORK_TYPE_EVDO_0:
                        case TelephonyManager.NETWORK_TYPE_EVDO_A:
                        case TelephonyManager.NETWORK_TYPE_HSDPA:
                        ...
                        case 14: // TelephonyManager.NETWORK_TYPE_EHRPD:
                        case 15: // TelephonyManager.NETWORK_TYPE_HSPAP:
                            return LinkNetWorkType.Type_3G;
                        case 13: // TelephonyManager.NETWORK_TYPE_LTE:
                            return LinkNetWorkType.Type_4G;
                        default:
                            return LinkNetWorkType.Type_2G;
                        }
                    }
