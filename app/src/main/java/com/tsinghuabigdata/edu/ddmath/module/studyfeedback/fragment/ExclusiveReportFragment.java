 ...
 */
@Deprecated
public class ExclusiveReportFragment extends ReportBaseFragment implements PullToRefreshBase.OnRefreshListener2, AdapterView.OnItemClickListener {
    ...
    private void initData() {
        createLoginInfo();
        getReportList();
        mAdapter = new ExclusiveReportAdapter(mContext, mList);
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        if( reportInfo.getRightQuestionCount()+reportInfo.getWrongQuestionCount() == (int)reportInfo.getTotalScore() ){
            ...
            MessageUtils.gotoWeekWorkReport(mContext, examId, studentId, classId, reportName, timeText);
        }
    }
