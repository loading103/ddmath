...
public class CrashHandler implements UncaughtExceptionHandler {
    ...
    public void uncaughtException(Thread thread, Throwable ex) {
        ...
        //ex = new Exception(AppLog.wrapMessage(""), ex);
        // 异常处理
        handleException(ex);
        // 如果有默认处理，使用默认的异常处理
    ...
    public void collectDeviceInfo(Context ctx) {
        try {
            ...
            AppLog.i("an error occured when collect package info", e);
        }
...
//                Log.d("xxxxx",key + " = " + value);
//                if( "SUPPORTED_32_BIT_ABIS".equals( key ) ){
//                    infos.put(key,value );
//                }
//            } catch (Exception e) {
//                AppLog.i("an error occured when collect crash info", e);
//            }
//        }
    }
