package com.tsinghuabigdata.edu.ddmath.module.scoreplan.view;
import android.content.Context;
import android.graphics.Canvas; import android.graphics.DashPathEffect;
...
public class ImaginaryLineView extends View {
    ...
    private int width;
    private int height;
    private int defaultColor=0xffdddddd;
    ...
    private void init() {
        ...
        effects = new DashPathEffect(new float[]{15, 15}, 0);
    }
    //设置线的必要属性  十六进制颜色值  虚线宽度，单位是dp
    public void setLineAttribute(int color, float lineWidth,float[] f) {
        ...
        mPaint.setStrokeWidth(dip2px(ct, lineWidth));  mPaint.setColor(color);    invalidate(); }
    @Override
