package com.tsinghuabigdata.edu.ddmath.module.neteaseim.base.util.log;
...
final class LogImpl {
	...
	private static void o(final int priority, final String tag, final String msg, final Throwable tr) {
