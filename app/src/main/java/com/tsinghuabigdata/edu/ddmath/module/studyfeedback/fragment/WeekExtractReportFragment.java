...
import com.tsinghuabigdata.edu.ddmath.module.studyfeedback.adapter.WeekExtractReportAdapter;
 ...
 */
@Deprecated
public class WeekExtractReportFragment extends ReportBaseFragment implements PullToRefreshBase.OnRefreshListener2, AdapterView.OnItemClickListener {
    ...
    private WeekExtractReportAdapter mAdapter;
    ...
    private void initData() {
        createLoginInfo();
        getReportList();
        mAdapter = new WeekExtractReportAdapter(mContext, mList);
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        String timeText = ReportUtils.getUpdateTimeText(reportInfo.getCreateTime());
        MessageUtils.gotoWeekExtractReport(mContext, examId, studentId, classId, reportName, timeText);
    }
