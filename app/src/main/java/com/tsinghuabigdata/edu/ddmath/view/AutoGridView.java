...
public class AutoGridView extends GridView {
    ...
    private boolean extendAllItem = false;
    ...
    public void setExtendAllItem(boolean extendAllItem) {
        this.extendAllItem = extendAllItem;
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        if(extendAllItem) heightMeasureSpec = MeasureSpec.makeMeasureSpec(Integer.MAX_VALUE >> 2,  MeasureSpec.AT_MOST);
     ...
     *  The first visible position (adapter order)
     */
