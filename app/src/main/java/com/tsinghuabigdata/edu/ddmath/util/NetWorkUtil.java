...
//    }
    ...
    private static int getNetworkClassByType(int networkType,String subname) {
        switch (networkType) {
            ...
            default:
                ...
                if( subname!=null && (subname.equalsIgnoreCase("TD-SCDMA") || subname.equalsIgnoreCase("WCDMA") || subname.equalsIgnoreCase("CDMA2000")) )
                {
                    return NETWORK_CLASS_3_G;
                }
                else
    ...
    public static int getNetworkClass( Context context ) {
        ...
        try {
            ...
            if (network != null && network.isAvailable()
                ...
                subname = network.getSubtypeName();
        ...
        return getNetworkClassByType(networkType,subname);
