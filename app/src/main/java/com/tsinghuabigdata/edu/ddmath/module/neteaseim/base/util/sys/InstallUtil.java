...
public class InstallUtil {
    ...
    public static boolean isAppInstalled(Context context, String packageName) {
        try {
            ...
            AppLog.i("", localNameNotFoundException);
            return false;
        }
    }
    ...
    public static String getVersionName() {
        String packageName = ZxApplication.getApplication().getPackageName();
        try {
            PackageInfo pi = ZxApplication.getApplication().getPackageManager().getPackageInfo(packageName, 0);
            if (pi != null) {
                return pi.versionName;
            } else {
                return null;
